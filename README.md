...
This repository contains data and analysis code to reproduce results from the article **"Demographic processes constrain global growth in gender egalitarianism"** (https://doi.org/10.1093/pnasnexus/pgag133).
